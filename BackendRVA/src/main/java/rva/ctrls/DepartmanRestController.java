...
public class DepartmanRestController {
	...
	@ApiOperation(value = "Vraća departman iz baze podataka čija je id vrednost prosleđena kao path varijabla")
	...
	@ApiOperation(value = "Briše departman iz baze podataka čija je id vrednost prosleđena kao path varijabla, kao i sve studente koji su mu pripadali")
	@Transactional
